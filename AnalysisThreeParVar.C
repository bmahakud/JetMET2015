...
const unsigned double markerstyle=23;
const unsigned double markersize=1.2;
...
TH1F *JetRsAKgenTr_nPV_h[NumtrPar][nPVnumOfbins];
...
TH1F *JetRsAKgenPr_nPV_h[NumprPar][nPVnumOfbins];
...
TH1F *JetRsAKgenSd_nPV_h[NumsdPar][nPVnumOfbins];
...
char histnamegen1[100];
char histnamegen2[100];
char histnamegen3[100];


char histnamepf[100];
char histnamechs[100];
char histnamepuppi[100];
char histnamegen[100];
...
sprintf(histnamegen,"ResponseGENnPVbins_%i",ii);
...
JetRsAKgen[ii]=new TH1F(histnamegen,histnamegen,NoOfbins,rangeMin,rangeMax);
...
sprintf(histnamegen1,"ResponseTrGENnPVbins_%i_%i",ii,jj);
...
JetRsAKgenTr_nPV_h[jj][ii]= new TH1F(histnamegen1,histnamegen1,NoOfbins,rangeMin,rangeMax);
...
sprintf(histnamegen2,"ResponsePrGENnPVbins_%i_%i",ii,jj);
...
JetRsAKgenPr_nPV_h[jj][ii]= new TH1F(histnamegen2,histnamegen2,NoOfbins,rangeMin,rangeMax);
...
sprintf(histnamegen3,"ResponseSdGENnPVbins_%i_%i",ii,jj);
...
JetRsAKgenSd_nPV_h[jj][ii]= new TH1F(histnamegen3,histnamegen3,NoOfbins,rangeMin,rangeMax);
...
//if(i !=2644 && i !=8575 && i != 12424 && i !=17508 && i !=35801 && i != 41741 && i != 41949){//bad events filtered
...
if(pf_pttrimsafe_Rtrim_020_Ptfrac_005->at(0) > pTmin  && pf_pttrimsafe_Rtrim_020_Ptfrac_005->at(0) < pTmax ){
      JetRsAKpfTr_nPV_h[0][ii2]->Fill(pf_mtrimsafe_Rtrim_020_Ptfrac_005->at(0));
          }

if(pf_pttrimsafe_Rtrim_010_Ptfrac_003->at(0) > pTmin && pf_pttrimsafe_Rtrim_010_Ptfrac_003->at(0) < pTmax ){
      JetRsAKpfTr_nPV_h[1][ii2]->Fill(pf_mtrimsafe_Rtrim_010_Ptfrac_003->at(0));
 }

if(pf_pttrimsafe_Rtrim_020_Ptfrac_003->at(0) > pTmin && pf_pttrimsafe_Rtrim_020_Ptfrac_003->at(0) < pTmax ){
      JetRsAKpfTr_nPV_h[2][ii2]->Fill(pf_mtrimsafe_Rtrim_020_Ptfrac_003->at(0));
 }

if(pf_pttrimsafe_Rtrim_030_Ptfrac_003->at(0) > pTmin &&  pf_pttrimsafe_Rtrim_030_Ptfrac_003->at(0) < pTmax ){
      JetRsAKpfTr_nPV_h[3][ii2]->Fill(pf_mtrimsafe_Rtrim_030_Ptfrac_003->at(0));
 }

  if(chs_pttrimsafe_Rtrim_020_Ptfrac_005->at(0) > pTmin  && chs_pttrimsafe_Rtrim_020_Ptfrac_005->at(0) < pTmax ){
     JetRsAKchsTr_nPV_h [0][ii2]->Fill(chs_mtrimsafe_Rtrim_020_Ptfrac_005->at(0));
 }

if(chs_pttrimsafe_Rtrim_010_Ptfrac_003->at(0) > pTmin &&  chs_pttrimsafe_Rtrim_010_Ptfrac_003->at(0) < pTmax ){
      JetRsAKchsTr_nPV_h[1][ii2]->Fill(chs_mtrimsafe_Rtrim_010_Ptfrac_003->at(0));
 }

if(chs_pttrimsafe_Rtrim_020_Ptfrac_003->at(0) > pTmin &&  chs_pttrimsafe_Rtrim_020_Ptfrac_003->at(0) < pTmax ){
      JetRsAKchsTr_nPV_h[2][ii2]->Fill(chs_mtrimsafe_Rtrim_020_Ptfrac_003->at(0));
 }

if(chs_pttrimsafe_Rtrim_030_Ptfrac_003->at(0) > pTmin  && chs_pttrimsafe_Rtrim_030_Ptfrac_003->at(0) < pTmax ){
      JetRsAKchsTr_nPV_h[3][ii2]->Fill(chs_mtrimsafe_Rtrim_030_Ptfrac_003->at(0));
 }

if(puppi_pttrim_Rtrim_020_Ptfrac_005->at(0) > pTmin &&  puppi_pttrim_Rtrim_020_Ptfrac_005->at(0) < pTmax ){
      JetRsAKpuppiTr_nPV_h[0][ii2]->Fill(puppi_mtrim_Rtrim_020_Ptfrac_005->at(0));
 }
if(puppi_pttrim_Rtrim_010_Ptfrac_003->at(0) > pTmin &&  puppi_pttrim_Rtrim_010_Ptfrac_003->at(0) < pTmax ){
     JetRsAKpuppiTr_nPV_h [1][ii2]->Fill(puppi_mtrim_Rtrim_010_Ptfrac_003->at(0));
 }


if(puppi_pttrim_Rtrim_020_Ptfrac_003->at(0) > pTmin && puppi_pttrim_Rtrim_020_Ptfrac_003->at(0) < pTmax ){
      JetRsAKpuppiTr_nPV_h[2][ii2]->Fill(puppi_mtrim_Rtrim_020_Ptfrac_003->at(0));
 }
if(puppi_pttrim_Rtrim_030_Ptfrac_003->at(0) > pTmin &&  puppi_pttrim_Rtrim_030_Ptfrac_003->at(0) < pTmax ){
      JetRsAKpuppiTr_nPV_h[3][ii2]->Fill(puppi_mtrim_Rtrim_030_Ptfrac_003->at(0));
 }

if(gen_pttrim_Rtrim_020_Ptfrac_005->at(0) > pTmin &&  gen_pttrim_Rtrim_020_Ptfrac_005->at(0) < pTmax ){
      JetRsAKgenTr_nPV_h[0][ii2]->Fill(gen_mtrim_Rtrim_020_Ptfrac_005->at(0));
 }
if(gen_pttrim_Rtrim_010_Ptfrac_003->at(0) > pTmin &&  gen_pttrim_Rtrim_010_Ptfrac_003->at(0) < pTmax ){
     JetRsAKgenTr_nPV_h [1][ii2]->Fill(gen_mtrim_Rtrim_010_Ptfrac_003->at(0));
 }

if(gen_pttrim_Rtrim_020_Ptfrac_003->at(0) > pTmin && gen_pttrim_Rtrim_020_Ptfrac_003->at(0) < pTmax ){
      JetRsAKgenTr_nPV_h[2][ii2]->Fill(gen_mtrim_Rtrim_020_Ptfrac_003->at(0));
 }
if(gen_pttrim_Rtrim_030_Ptfrac_003->at(0) > pTmin &&  gen_pttrim_Rtrim_030_Ptfrac_003->at(0) < pTmax ){
      JetRsAKgenTr_nPV_h[3][ii2]->Fill(gen_mtrim_Rtrim_030_Ptfrac_003->at(0));
 }
...
if(pf_ptprunedsafe_zcut_010_R_cut_050->at(0) > pTmin &&  pf_ptprunedsafe_zcut_010_R_cut_050->at(0) < pTmax ){
       JetRsAKpfPr_nPV_h[0][ii2]->Fill(pf_mprunedsafe_zcut_010_R_cut_050->at(0));
 }

if(pf_ptprunedsafe_zcut_005_R_cut_050->at(0) > pTmin &&  pf_ptprunedsafe_zcut_005_R_cut_050->at(0) < pTmax ){
       JetRsAKpfPr_nPV_h[1][ii2]->Fill(pf_mprunedsafe_zcut_005_R_cut_050->at(0));
 }
if(pf_ptprunedsafe_zcut_005_R_cut_075->at(0) > pTmin &&  pf_ptprunedsafe_zcut_005_R_cut_075->at(0) < pTmax ){
       JetRsAKpfPr_nPV_h[2][ii2]->Fill(pf_mprunedsafe_zcut_005_R_cut_075->at(0));
 }
if(pf_ptprunedsafe_zcut_010_R_cut_075->at(0) > pTmin &&  pf_ptprunedsafe_zcut_010_R_cut_075->at(0) < pTmax ){
      JetRsAKpfPr_nPV_h [3][ii2]->Fill(pf_mprunedsafe_zcut_010_R_cut_075->at(0));
 }


if(chs_ptprunedsafe_zcut_010_R_cut_050->at(0) > pTmin && chs_ptprunedsafe_zcut_010_R_cut_050->at(0) < pTmax ){
       JetRsAKchsPr_nPV_h[0][ii2]->Fill(chs_mprunedsafe_zcut_010_R_cut_050->at(0));
 }
if(chs_ptprunedsafe_zcut_005_R_cut_050->at(0) > pTmin &&  chs_ptprunedsafe_zcut_005_R_cut_050->at(0) < pTmax ){
      JetRsAKchsPr_nPV_h[1][ii2]->Fill(chs_mprunedsafe_zcut_005_R_cut_050->at(0));
 }
if(chs_ptprunedsafe_zcut_005_R_cut_075->at(0) > pTmin && chs_ptprunedsafe_zcut_005_R_cut_075->at(0) < pTmax ){
      JetRsAKchsPr_nPV_h[2][ii2]->Fill(chs_mprunedsafe_zcut_005_R_cut_075->at(0));
 }
if(chs_ptprunedsafe_zcut_010_R_cut_075->at(0) > pTmin &&  chs_ptprunedsafe_zcut_010_R_cut_075->at(0) < pTmax ){
       JetRsAKchsPr_nPV_h[3][ii2]->Fill(chs_mprunedsafe_zcut_010_R_cut_075->at(0));
 }


if(puppi_ptpruned_zcut_010_R_cut_050->at(0) > pTmin &&  puppi_ptpruned_zcut_010_R_cut_050->at(0) < pTmax ){
       JetRsAKpuppiPr_nPV_h[0][ii2]->Fill(puppi_mpruned_zcut_010_R_cut_050->at(0));
 }
if(puppi_ptpruned_zcut_005_R_cut_050->at(0) > pTmin &&  puppi_ptpruned_zcut_005_R_cut_050->at(0) < pTmax ){
      JetRsAKpuppiPr_nPV_h[1][ii2]->Fill(puppi_mpruned_zcut_005_R_cut_050->at(0));
 }
if(puppi_ptpruned_zcut_005_R_cut_075->at(0) > pTmin &&  puppi_ptpruned_zcut_005_R_cut_075->at(0) < pTmax ){
       JetRsAKpuppiPr_nPV_h[2][ii2]->Fill(puppi_mpruned_zcut_005_R_cut_075->at(0));
 }
if(puppi_ptpruned_zcut_010_R_cut_075->at(0) > pTmin &&  puppi_ptpruned_zcut_010_R_cut_075->at(0) < pTmax ){
       JetRsAKpuppiPr_nPV_h[3][ii2]->Fill(puppi_mpruned_zcut_010_R_cut_075->at(0));
 }

if(gen_ptpruned_zcut_010_R_cut_050->at(0) > pTmin &&  gen_ptpruned_zcut_010_R_cut_050->at(0) < pTmax ){
       JetRsAKgenPr_nPV_h[0][ii2]->Fill(gen_mpruned_zcut_010_R_cut_050->at(0));
 }
if(gen_ptpruned_zcut_005_R_cut_050->at(0) > pTmin &&  gen_ptpruned_zcut_005_R_cut_050->at(0) < pTmax ){
      JetRsAKgenPr_nPV_h[1][ii2]->Fill(gen_mpruned_zcut_005_R_cut_050->at(0));
 }
if(gen_ptpruned_zcut_005_R_cut_075->at(0) > pTmin &&  gen_ptpruned_zcut_005_R_cut_075->at(0) < pTmax ){
       JetRsAKgenPr_nPV_h[2][ii2]->Fill(gen_mpruned_zcut_005_R_cut_075->at(0));
 }
if(gen_ptpruned_zcut_010_R_cut_075->at(0) > pTmin &&  gen_ptpruned_zcut_010_R_cut_075->at(0) < pTmax ){
       JetRsAKgenPr_nPV_h[3][ii2]->Fill(gen_mpruned_zcut_010_R_cut_075->at(0));
 }
...
if(pf_ptsoftdropsafe_beta20->at(0) > pTmin &&  pf_ptsoftdropsafe_beta20->at(0) < pTmax ){
       JetRsAKpfSd_nPV_h[0][ii2]->Fill(pf_msoftdropsafe_beta20->at(0));
 }
if(pf_ptsoftdropsafe_beta00->at(0) > pTmin &&  pf_ptsoftdropsafe_beta00->at(0) < pTmax ){
      JetRsAKpfSd_nPV_h[1][ii2]->Fill(pf_msoftdropsafe_beta00->at(0));
 }
if(pf_ptsoftdropsafe_beta10->at(0) > pTmin &&  pf_ptsoftdropsafe_beta10->at(0) < pTmax ){
       JetRsAKpfSd_nPV_h[2][ii2]->Fill(pf_msoftdropsafe_beta10->at(0));
 }
if(pf_ptsoftdropsafe_betam1->at(0) > pTmin &&  pf_ptsoftdropsafe_betam1->at(0) < pTmax ){
       JetRsAKpfSd_nPV_h[3][ii2]->Fill(pf_msoftdropsafe_betam1->at(0));
 }
if(chs_ptsoftdropsafe_beta20->at(0) > pTmin &&  chs_ptsoftdropsafe_beta20->at(0) < pTmax ){
      JetRsAKchsSd_nPV_h[0][ii2]->Fill(chs_msoftdropsafe_beta20->at(0));
 }
if(chs_ptsoftdropsafe_beta00->at(0) > pTmin &&  chs_ptsoftdropsafe_beta00->at(0) < pTmax ){
       JetRsAKchsSd_nPV_h[1][ii2]->Fill(chs_msoftdropsafe_beta00->at(0));
}
if(chs_ptsoftdropsafe_beta10->at(0) > pTmin &&  chs_ptsoftdropsafe_beta10->at(0) < pTmax ){
       JetRsAKchsSd_nPV_h[2][ii2]->Fill(chs_msoftdropsafe_beta10->at(0));
}
if(chs_ptsoftdropsafe_betam1->at(0) > pTmin &&  chs_ptsoftdropsafe_betam1->at(0) < pTmax ){
       JetRsAKchsSd_nPV_h[3][ii2]->Fill(chs_msoftdropsafe_betam1->at(0));
}

if(puppi_ptsoftdrop_beta20->at(0) > pTmin &&  puppi_ptsoftdrop_beta20->at(0) < pTmax ){
       JetRsAKpuppiSd_nPV_h[0][ii2]->Fill(puppi_msoftdrop_beta20->at(0));
}
if(puppi_ptsoftdrop_beta00->at(0) > pTmin &&  puppi_ptsoftdrop_beta00->at(0) < pTmax ){
       JetRsAKpuppiSd_nPV_h[1][ii2]->Fill(puppi_msoftdrop_beta00->at(0));
}
if(puppi_ptsoftdropsafe_beta10->at(0) > pTmin &&  puppi_ptsoftdrop_beta10->at(0) < pTmax ){
       JetRsAKpuppiSd_nPV_h[2][ii2]->Fill(puppi_msoftdrop_beta10->at(0));
}
if(puppi_ptsoftdrop_betam1->at(0) > pTmin && puppi_ptsoftdrop_betam1->at(0) < pTmax ){
       JetRsAKpuppiSd_nPV_h[3][ii2]->Fill(puppi_msoftdrop_betam1->at(0));
}

if(gen_ptsoftdrop_beta20->at(0) > pTmin &&  gen_ptsoftdrop_beta20->at(0) < pTmax ){
       JetRsAKgenSd_nPV_h[0][ii2]->Fill(gen_msoftdrop_beta20->at(0));
}
if(gen_ptsoftdrop_beta00->at(0) > pTmin &&  gen_ptsoftdrop_beta00->at(0) < pTmax ){
       JetRsAKgenSd_nPV_h[1][ii2]->Fill(gen_msoftdrop_beta00->at(0));
}
if(gen_ptsoftdrop_beta10->at(0) > pTmin &&  gen_ptsoftdrop_beta10->at(0) < pTmax ){
       JetRsAKgenSd_nPV_h[2][ii2]->Fill(gen_msoftdrop_beta10->at(0));
}
if(gen_ptsoftdrop_betam1->at(0) > pTmin && gen_ptsoftdrop_betam1->at(0) < pTmax ){
       JetRsAKgenSd_nPV_h[3][ii2]->Fill(gen_msoftdrop_betam1->at(0));
}
...
double gen_tr_meanX_nPV[NumtrPar][nPVnumOfbins];
double gen_tr_meanY_nPV[NumtrPar][nPVnumOfbins];
double gen_tr_meanYerr_nPV[NumtrPar][nPVnumOfbins];
double gen_tr_meanXerr_nPV[NumtrPar][nPVnumOfbins];


double gen_tr_sigmaX_nPV[NumtrPar][nPVnumOfbins];
double gen_tr_sigmaY_nPV[NumtrPar][nPVnumOfbins];
double gen_tr_sigmaXerr_nPV[NumtrPar][nPVnumOfbins];
double gen_tr_sigmaYerr_nPV[NumtrPar][nPVnumOfbins];
...
double gen_pr_meanX_nPV[NumprPar][nPVnumOfbins];
double gen_pr_meanY_nPV[NumprPar][nPVnumOfbins];
double gen_pr_meanXerr_nPV[NumprPar][nPVnumOfbins];
double gen_pr_meanYerr_nPV[NumprPar][nPVnumOfbins];

double gen_pr_sigmaX_nPV[NumprPar][nPVnumOfbins];
double gen_pr_sigmaY_nPV[NumprPar][nPVnumOfbins];
double gen_pr_sigmaXerr_nPV[NumprPar][nPVnumOfbins];
double gen_pr_sigmaYerr_nPV[NumprPar][nPVnumOfbins];
...
double gen_sd_meanX_nPV[NumsdPar][nPVnumOfbins];
double gen_sd_meanY_nPV[NumsdPar][nPVnumOfbins];
double gen_sd_meanXerr_nPV[NumsdPar][nPVnumOfbins];
double gen_sd_meanYerr_nPV[NumsdPar][nPVnumOfbins];

double gen_sd_sigmaX_nPV[NumsdPar][nPVnumOfbins];
double gen_sd_sigmaY_nPV[NumsdPar][nPVnumOfbins];
double gen_sd_sigmaXerr_nPV[NumsdPar][nPVnumOfbins];
double gen_sd_sigmaYerr_nPV[NumsdPar][nPVnumOfbins];


//cout<<"bin size = "<<nPVbinsize<<endl;
...
JetRsAKgenTr_nPV_h[jj3][ii3]->Scale(1/JetRsAKgenTr_nPV_h[jj3][ii3]->Integral());
...
//cout<<"pf_tr_meanXerr_nPV = "<<pf_tr_meanXerr_nPV[jj3][ii3]<<endl;
...
gen_tr_meanX_nPV[jj3][ii3]=nPVmin+ii3*nPVbinsize +(binsize/2);
gen_tr_meanY_nPV[jj3][ii3]=JetRsAKgenTr_nPV_h[jj3][ii3]->GetMean();
gen_tr_meanYerr_nPV[jj3][ii3]=JetRsAKgenTr_nPV_h[jj3][ii3]->GetMeanError();
gen_tr_meanXerr_nPV[jj3][ii3]=x_err;


gen_tr_sigmaX_nPV[jj3][ii3]=nPVmin+ii3*nPVbinsize +(binsize/2);
gen_tr_sigmaY_nPV[jj3][ii3]=JetRsAKgenTr_nPV_h[jj3][ii3]->GetRMS();
gen_tr_sigmaYerr_nPV[jj3][ii3]=JetRsAKgenTr_nPV_h[jj3][ii3]->GetRMSError();
gen_tr_sigmaXerr_nPV[jj3][ii3]=x_err;
...
JetRsAKgenPr_nPV_h[jj3][ii3]->Scale(1/JetRsAKgenPr_nPV_h[jj3][ii3]->Integral());
...
gen_pr_meanX_nPV[jj3][ii3]=nPVmin+ii3*nPVbinsize +(binsize/2);
gen_pr_meanY_nPV[jj3][ii3]=JetRsAKgenPr_nPV_h[jj3][ii3]->GetMean();
gen_pr_meanYerr_nPV[jj3][ii3]=JetRsAKgenPr_nPV_h[jj3][ii3]->GetMeanError();
gen_pr_meanXerr_nPV[jj3][ii3]=x_err;

gen_pr_sigmaX_nPV[jj3][ii3]=nPVmin+ii3*nPVbinsize +(binsize/2);
gen_pr_sigmaY_nPV[jj3][ii3]=JetRsAKgenPr_nPV_h[jj3][ii3]->GetRMS();
gen_pr_sigmaYerr_nPV[jj3][ii3]=JetRsAKgenPr_nPV_h[jj3][ii3]->GetRMSError();
gen_pr_sigmaXerr_nPV[jj3][ii3]=x_err;
...
JetRsAKgenSd_nPV_h[jj3][ii3]->Scale(1/JetRsAKgenSd_nPV_h[jj3][ii3]->Integral());
...
gen_sd_meanX_nPV[jj3][ii3]=nPVmin+ii3*nPVbinsize +(binsize/2);
gen_sd_meanY_nPV[jj3][ii3]=JetRsAKgenSd_nPV_h[jj3][ii3]->GetMean();
gen_sd_meanYerr_nPV[jj3][ii3]=JetRsAKgenSd_nPV_h[jj3][ii3]->GetMeanError();
gen_sd_meanXerr_nPV[jj3][ii3]=x_err;


gen_sd_sigmaX_nPV[jj3][ii3]=nPVmin+ii3*nPVbinsize +(binsize/2);
gen_sd_sigmaY_nPV[jj3][ii3]=JetRsAKgenSd_nPV_h[jj3][ii3]->GetRMS();
gen_sd_sigmaYerr_nPV[jj3][ii3]=JetRsAKgenSd_nPV_h[jj3][ii3]->GetRMSError();
gen_sd_sigmaXerr_nPV[jj3][ii3]=x_err;
...
TGraphErrors *gen_graph_trMeanvsNpv[NumtrPar];
TGraphErrors *gen_graph_trSigmavsNpv[NumtrPar];
TGraphErrors *gen_graph_prMeanvsNpv[NumprPar];
TGraphErrors *gen_graph_prSigmavsNpv[NumprPar];
TGraphErrors *gen_graph_sdMeanvsNpv[NumsdPar];
TGraphErrors *gen_graph_sdSigmavsNpv[NumsdPar];
...
pf_graph_trMeanvsNpv[j1]->SetMarkerStyle(20);
...
pf_graph_trSigmavsNpv[j1]->SetMarkerStyle(20);
...
chs_graph_trMeanvsNpv[j1]->SetMarkerStyle(20);
...
chs_graph_trSigmavsNpv[j1]->SetMarkerStyle(20);
...
puppi_graph_trMeanvsNpv[j1]->SetMarkerStyle(20);
...
puppi_graph_trSigmavsNpv[j1]->SetMarkerStyle(20);
puppi_graph_trSigmavsNpv[j1]->SetMarkerColor(j1+1);
puppi_graph_trSigmavsNpv[j1]->SetMarkerSize(markersize);
gen_graph_trMeanvsNpv[j1]  = new TGraphErrors(nPVnumOfbins,gen_tr_meanX_nPV[j1],gen_tr_meanY_nPV[j1],gen_tr_meanXerr_nPV[j1],gen_tr_meanYerr_nPV[j1]);
gen_graph_trMeanvsNpv[j1]->SetLineColor(j1+1);
gen_graph_trMeanvsNpv[j1]->SetLineWidth(linewidth);
gen_graph_trMeanvsNpv[j1]->SetMarkerStyle(20);
gen_graph_trMeanvsNpv[j1]->SetMarkerColor(j1+1);
gen_graph_trMeanvsNpv[j1]->SetMarkerSize(markersize);
gen_graph_trSigmavsNpv[j1]  = new TGraphErrors(nPVnumOfbins,gen_tr_sigmaX_nPV[j1],gen_tr_sigmaY_nPV[j1],gen_tr_sigmaXerr_nPV[j1],gen_tr_sigmaYerr_nPV[j1]);
gen_graph_trSigmavsNpv[j1]->SetLineColor(j1+1);
gen_graph_trSigmavsNpv[j1]->SetLineWidth(linewidth);
gen_graph_trSigmavsNpv[j1]->SetMarkerStyle(20);
gen_graph_trSigmavsNpv[j1]->SetMarkerColor(j1+1);
gen_graph_trSigmavsNpv[j1]->SetMarkerSize(markersize);
...
pf_graph_prMeanvsNpv[j1]->SetMarkerStyle(20);
...
pf_graph_prSigmavsNpv[j1]->SetMarkerStyle(20);
...
chs_graph_prMeanvsNpv[j1]->SetMarkerStyle(20);
...
chs_graph_prSigmavsNpv[j1]->SetMarkerStyle(20);
...
puppi_graph_prMeanvsNpv[j1]->SetMarkerStyle(20);
...
puppi_graph_prSigmavsNpv[j1]->SetMarkerStyle(20);
puppi_graph_prSigmavsNpv[j1]->SetMarkerColor(j1+1);
puppi_graph_prSigmavsNpv[j1]->SetMarkerSize(markersize);

gen_graph_prMeanvsNpv[j1]  = new TGraphErrors(nPVnumOfbins,gen_pr_meanX_nPV[j1],gen_pr_meanY_nPV[j1],gen_pr_meanXerr_nPV[j1],gen_pr_meanYerr_nPV[j1]);
gen_graph_prMeanvsNpv[j1]->SetLineColor(j1+1);
gen_graph_prMeanvsNpv[j1]->SetLineWidth(linewidth);
gen_graph_prMeanvsNpv[j1]->SetMarkerStyle(20);
gen_graph_prMeanvsNpv[j1]->SetMarkerColor(j1+1);
gen_graph_prMeanvsNpv[j1]->SetMarkerSize(markersize);
gen_graph_prSigmavsNpv[j1]  = new TGraphErrors(nPVnumOfbins,gen_pr_sigmaX_nPV[j1],gen_pr_sigmaY_nPV[j1],gen_pr_sigmaXerr_nPV[j1],gen_pr_sigmaYerr_nPV[j1]);
gen_graph_prSigmavsNpv[j1]->SetLineColor(j1+1);
gen_graph_prSigmavsNpv[j1]->SetLineWidth(linewidth);
gen_graph_prSigmavsNpv[j1]->SetMarkerStyle(20);
gen_graph_prSigmavsNpv[j1]->SetMarkerColor(j1+1);
gen_graph_prSigmavsNpv[j1]->SetMarkerSize(markersize);
...
pf_graph_sdMeanvsNpv[j1]->SetMarkerStyle(20);
...
pf_graph_sdSigmavsNpv[j1]->SetMarkerStyle(20);
...
chs_graph_sdMeanvsNpv[j1]->SetMarkerStyle(20);
...
chs_graph_sdSigmavsNpv[j1]->SetMarkerStyle(20);
...
puppi_graph_sdMeanvsNpv[j1]->SetMarkerStyle(20);
...
puppi_graph_sdSigmavsNpv[j1]->SetMarkerStyle(20);
puppi_graph_sdSigmavsNpv[j1]->SetMarkerColor(j1+1);
puppi_graph_sdSigmavsNpv[j1]->SetMarkerSize(markersize);

gen_graph_sdMeanvsNpv[j1]  = new TGraphErrors(nPVnumOfbins,gen_sd_meanX_nPV[j1],gen_sd_meanY_nPV[j1],gen_sd_meanXerr_nPV[j1],gen_sd_meanYerr_nPV[j1]);
gen_graph_sdMeanvsNpv[j1]->SetLineColor(j1+1);
gen_graph_sdMeanvsNpv[j1]->SetLineWidth(linewidth);
gen_graph_sdMeanvsNpv[j1]->SetMarkerStyle(20);
gen_graph_sdMeanvsNpv[j1]->SetMarkerColor(j1+1);
gen_graph_sdMeanvsNpv[j1]->SetMarkerSize(markersize);

gen_graph_sdSigmavsNpv[j1]  = new TGraphErrors(nPVnumOfbins,gen_sd_sigmaX_nPV[j1],gen_sd_sigmaY_nPV[j1],gen_sd_sigmaXerr_nPV[j1],gen_sd_sigmaYerr_nPV[j1]);
gen_graph_sdSigmavsNpv[j1]->SetLineColor(j1+1);
gen_graph_sdSigmavsNpv[j1]->SetLineWidth(linewidth);
gen_graph_sdSigmavsNpv[j1]->SetMarkerStyle(20);
gen_graph_sdSigmavsNpv[j1]->SetMarkerColor(j1+1);
gen_graph_sdSigmavsNpv[j1]->SetMarkerSize(markersize);
...
TLatex *tex1 = new TLatex(13.32924,80.53077,"CMS Simulation Preliminary, #sqrt{s}= 13 TeV");
   tex1->SetLineWidth(0.3);
   tex1->SetTextSize(0.04);
   
 TLatex *tex2 = new TLatex(15.31029,74.93871,"QCD, Anti-kT (R=0.8)");
   tex2->SetLineWidth(0.02);
   tex2->SetTextSize(0.03);

TLatex *tex3 = new TLatex(15.89011,70.67358," 300< p_{T}< 470 GeV");
   tex3->SetLineWidth(0.02);
   tex3->SetTextSize(0.03);

TLatex *tex4 = new TLatex(17.77452,66.97713," |#eta|< 2.5");
...
TLatex *texc0 = new TLatex(17.58125,63.47024,"PF");
...
TMg_1D[0]->SetMinimum(20);
TMg_1D[0]->SetMaximum(80);
TMg_1D[0]->SetTitle(" ;n_{PV} ;< m_{trim} > (GeV) ");
TMg_1D[0]->Draw("AP");

leg_1D[0]->AddEntry(pf_graph_trMeanvsNpv[0],"Trimmed (r_{filt}=0.2,pT_{frac}=0.05) ","l");
leg_1D[0]->AddEntry(pf_graph_trMeanvsNpv[1],"Trimmed (r_{filt}=0.1,pT_{frac}=0.03) ","l");
leg_1D[0]->AddEntry(pf_graph_trMeanvsNpv[2],"Trimmed (r_{filt}=0.2,pT_{frac}=0.03) ","l");
leg_1D[0]->AddEntry(pf_graph_trMeanvsNpv[3],"Trimmed (r_{filt}=0.3,pT_{frac}=0.03)","l");
...
TLatex *texc1 = new TLatex(17.58125,63.47024,"PF+CHS ");
...
TMg_1D[1]->SetMinimum(20);
TMg_1D[1]->SetMaximum(80);

TMg_1D[1]->SetTitle(" ;n_{PV} ;< m_{trim} > (GeV) ");
TMg_1D[1]->Draw("AP");
leg_1D[1]->AddEntry(chs_graph_trMeanvsNpv[0],"Trimmed (r_{filt}=0.2,pT_{frac}=0.05) ","l");
leg_1D[1]->AddEntry(chs_graph_trMeanvsNpv[1],"Trimmed (r_{filt}=0.1,pT_{frac}=0.03) ","l");
leg_1D[1]->AddEntry(chs_graph_trMeanvsNpv[2],"Trimmed (r_{filt}=0.2,pT_{frac}=0.03) ","l");
leg_1D[1]->AddEntry(chs_graph_trMeanvsNpv[3],"Trimmed (r_{filt}=0.3,pT_{frac}=0.03)","l");
...
TLatex *texc2 = new TLatex(17.58125,63.47024,"PF+PUPPI ");
...
TMg_1D[2]->SetMinimum(20);
TMg_1D[2]->SetMaximum(80);
TMg_1D[2]->SetTitle(" ;n_{PV} ;< m_{trim} > (GeV) ");
TMg_1D[2]->Draw("AP");

leg_1D[2]->AddEntry(puppi_graph_trMeanvsNpv[0],"Trimmed (r_{filt}=0.2,pT_{frac}=0.05) ","l");
leg_1D[2]->AddEntry(puppi_graph_trMeanvsNpv[1],"Trimmed (r_{filt}=0.1,pT_{frac}=0.03) ","l");
leg_1D[2]->AddEntry(puppi_graph_trMeanvsNpv[2],"Trimmed (r_{filt}=0.2,pT_{frac}=0.03) ","l");
leg_1D[2]->AddEntry(puppi_graph_trMeanvsNpv[3],"Trimmed (r_{filt}=0.3,pT_{frac}=0.03)","l");
...
TLatex *texc3 = new TLatex(17.58125,63.47024,"GEN");
   texc3->SetLineWidth(0.05);
   texc3->SetTextSize(0.03);

c_1D[3]->cd();
TMg_1D[3]->Add(gen_graph_trMeanvsNpv[0]);
TMg_1D[3]->Add(gen_graph_trMeanvsNpv[1]);
TMg_1D[3]->Add(gen_graph_trMeanvsNpv[2]);
TMg_1D[3]->Add(gen_graph_trMeanvsNpv[3]);
TMg_1D[3]->SetMinimum(20);
TMg_1D[3]->SetMaximum(80);
TMg_1D[3]->SetTitle(" ;n_{PV} ;< m_{trim} > (GeV) ");
TMg_1D[3]->Draw("AP");

leg_1D[3]->AddEntry(gen_graph_trMeanvsNpv[0],"Trimmed (r_{filt}=0.2,pT_{frac}=0.05) ","l");
leg_1D[3]->AddEntry(gen_graph_trMeanvsNpv[1],"Trimmed (r_{filt}=0.1,pT_{frac}=0.03) ","l");
leg_1D[3]->AddEntry(gen_graph_trMeanvsNpv[2],"Trimmed (r_{filt}=0.2,pT_{frac}=0.03) ","l");
leg_1D[3]->AddEntry(gen_graph_trMeanvsNpv[3],"Trimmed (r_{filt}=0.3,pT_{frac}=0.03)","l");
...
TLatex *texc4 = new TLatex(17.58125,63.47024,"PF");
...
TMg_1D[4]->SetMinimum(20);
TMg_1D[4]->SetMaximum(80);
TMg_1D[4]->SetTitle(" ;n_{PV} ;< m_{pruned} > (GeV) ");
TMg_1D[4]->Draw("AP");

leg_1D[4]->AddEntry(pf_graph_prMeanvsNpv[0],"Pruned (z_{cut}=0.1,r_{cut}=0.5) ","l");
leg_1D[4]->AddEntry(pf_graph_prMeanvsNpv[1],"Pruned (z_{cut}=0.05,r_{cut}=0.5)","l");
...
////////////////////////////////////////pr2
TLatex *texc5 = new TLatex(17.58125,63.47024,"PF+CHS");
...
TMg_1D[5]->SetMinimum(20);
TMg_1D[5]->SetMaximum(80);
TMg_1D[5]->SetTitle(" ;n_{PV} ;< m_{pruned} > (GeV)");
TMg_1D[5]->Draw("AP");
...
TLatex *texc6 = new TLatex(17.58125,63.47024,"PF+PUPPI ");
...
TMg_1D[6]->SetMinimum(20);
TMg_1D[6]->SetMaximum(80);
TMg_1D[6]->SetTitle(" ;n_{PV} ;< m_{pruned} > (GeV) ");
TMg_1D[6]->Draw("AP");
...
TLatex *texc7 = new TLatex(17.58125,63.47024,"GEN");
   texc7->SetLineWidth(0.05);
   texc7->SetTextSize(0.03);

c_1D[7]->cd();
TMg_1D[7]->Add(gen_graph_prMeanvsNpv[0]);
TMg_1D[7]->Add(gen_graph_prMeanvsNpv[1]);
TMg_1D[7]->Add(gen_graph_prMeanvsNpv[2]);
TMg_1D[7]->Add(gen_graph_prMeanvsNpv[3]);
TMg_1D[7]->SetMinimum(20);
TMg_1D[7]->SetMaximum(80);

TMg_1D[7]->SetTitle(" ;n_{PV} ;< m_{pruned} > (GeV) ");
TMg_1D[7]->Draw("AP");

leg_1D[7]->AddEntry(gen_graph_prMeanvsNpv[0],"Pruned (z_{cut}=0.1,r_{cut}=0.5) ","l");
leg_1D[7]->AddEntry(gen_graph_prMeanvsNpv[1],"Pruned (z_{cut}=0.05,r_{cut}=0.5)","l");
leg_1D[7]->AddEntry(gen_graph_prMeanvsNpv[2],"Pruned (z_{cut}=0.05,r_{cut}=0.75) ","l");
leg_1D[7]->AddEntry(gen_graph_prMeanvsNpv[3],"Pruned (z_{cut}=0.1,r_{cut}=0.75) ","l");
...
TLatex *tex1 = new TLatex(13.32924,121.0426,"CMS Simulation Preliminary, #sqrt{s}= 13 TeV");
   tex1->SetLineWidth(0.3);
   tex1->SetTextSize(0.04);
   
 TLatex *tex2 = new TLatex(15.26197,112.6703,"QCD, Anti-kT (R=0.8)");
   tex2->SetLineWidth(0.02);
   tex2->SetTextSize(0.03);

TLatex *tex3 = new TLatex(15.21365,106.8255," 300 <p_{T}< 470 GeV");
   tex3->SetLineWidth(0.02);
   tex3->SetTextSize(0.03);

TLatex *tex4 = new TLatex(17.77452,99.87489," |#eta|< 2.5");
...
TLatex *texc8 = new TLatex(19.0308,94.66195,"PF");
...
TMg_1D[8]->SetMinimum(20);
TMg_1D[8]->SetMaximum(120);
TMg_1D[8]->SetTitle(" ;n_{PV} ;< m_{softdrop} > (GeV) ");
TMg_1D[8]->Draw("AP");
...
TLatex *texc9 = new TLatex(19.0308,94.66195,"PF+CHS ");
...
TMg_1D[9]->SetMinimum(20);
TMg_1D[9]->SetMaximum(120);

TMg_1D[9]->SetTitle(" ;n_{PV} ;< m_{softdrop} > (GeV) ");
TMg_1D[9]->Draw("AP");
...
TLatex *texc10 = new TLatex(19.0308,94.66195,"PF+PUPPI ");
...
TMg_1D[10]->SetMinimum(20);
TMg_1D[10]->SetMaximum(120);
TMg_1D[10]->SetTitle(" ;n_{PV} ;< m_{softdrop} > (GeV) ");
TMg_1D[10]->Draw("AP");
...
leg_1D[10]->Draw();
////////////////////////////////////////////sd4
TLatex *texc11 = new TLatex(19.0308,94.66195,"GEN ");
   texc11->SetLineWidth(0.05);
   texc11->SetTextSize(0.03);

c_1D[11]->cd();
TMg_1D[11]->Add(gen_graph_sdMeanvsNpv[0]);
TMg_1D[11]->Add(gen_graph_sdMeanvsNpv[1]);
TMg_1D[11]->Add(gen_graph_sdMeanvsNpv[2]);
//TMg_1D[11]->Add(gen_graph_sdMeanvsNpv[3]);

TMg_1D[11]->SetMinimum(20);
TMg_1D[11]->SetMaximum(120);


TMg_1D[11]->SetTitle(" ;n_{PV} ;< m_{softdrop} > (GeV) ");
TMg_1D[11]->Draw("AP");

leg_1D[11]->AddEntry(gen_graph_sdMeanvsNpv[0],"Softdrop #beta = 2 ","l");
leg_1D[11]->AddEntry(gen_graph_sdMeanvsNpv[1],"Softdrop #beta = 0 ","l");
leg_1D[11]->AddEntry(gen_graph_sdMeanvsNpv[2],"Softdrop #beta = 1 ","l");
//leg_1D[11]->AddEntry(gen_graph_sdMeanvsNpv[3],"Softdrop #beta = -1 ","l");
...
tex4->Draw();
texc11->Draw();
//leg_1D[11]->SetLineWidth(5);
leg_1D[11]->Draw();

/////////////////////////////////////////////////RMS
////////////////////////////tr1
/*
TLatex *texc12 = new TLatex(20.45501,24.0062,"Trimmed (r_{filt}=0.2,pT_{frac}=0.05)");
   texc12->SetLineWidth(0.05);
   texc12->SetTextSize(0.03);

c_1D[12]->cd();
TMg_1D[12]->Add(pf_graph_trSigmavsNpv[0]);
TMg_1D[12]->Add(chs_graph_trSigmavsNpv[0]);
TMg_1D[12]->Add(puppi_graph_trSigmavsNpv[0]);
TMg_1D[12]->SetTitle(" ;n_{PV} ;RMS[m_{RecoJet}-m_{GenJet}] (GeV) ");
TMg_1D[12]->Draw("AP");

leg_1D[12]->AddEntry(pf_graph_trSigmavsNpv[0],"PFlow  ","lp");
leg_1D[12]->AddEntry(chs_graph_trSigmavsNpv[0],"PFlow+CHS ","lp");
leg_1D[12]->AddEntry(puppi_graph_trSigmavsNpv[0],"PFlow+PUPPI ","lp");
...
TLatex *texc13 = new TLatex(20.45501,24.0062,"Trimmed (r_{filt}=0.1,pT_{frac}=0.03)");
   texc13->SetLineWidth(0.05);
   texc13->SetTextSize(0.03);

c_1D[13]->cd();
TMg_1D[13]->Add(pf_graph_trSigmavsNpv[1]);
TMg_1D[13]->Add(chs_graph_trSigmavsNpv[1]);
TMg_1D[13]->Add(puppi_graph_trSigmavsNpv[1]);
TMg_1D[13]->SetTitle(" ;n_{PV} ;RMS[m_{RecoJet}-m_{GenJet}] (GeV) ");
TMg_1D[13]->Draw("AP");

leg_1D[13]->AddEntry(pf_graph_trSigmavsNpv[1],"PFlow  ","lp");
leg_1D[13]->AddEntry(chs_graph_trSigmavsNpv[1],"PFlow+CHS ","lp");
leg_1D[13]->AddEntry(puppi_graph_trSigmavsNpv[1],"PFlow+PUPPI ","lp");
...
TLatex *texc14 = new TLatex(20.45501,24.0062,"Trimmed (r_{filt}=0.2,pT_{frac}=0.03)");
   texc14->SetLineWidth(0.05);
   texc14->SetTextSize(0.03);

c_1D[14]->cd();
TMg_1D[14]->Add(pf_graph_trSigmavsNpv[2]);
TMg_1D[14]->Add(chs_graph_trSigmavsNpv[2]);
TMg_1D[14]->Add(puppi_graph_trSigmavsNpv[2]);
TMg_1D[14]->SetTitle(" ;n_{PV} ;RMS[m_{RecoJet}-m_{GenJet}] (GeV) ");
TMg_1D[14]->Draw("AP");

leg_1D[14]->AddEntry(pf_graph_trSigmavsNpv[2],"PFlow  ","lp");
leg_1D[14]->AddEntry(chs_graph_trSigmavsNpv[2],"PFlow+CHS ","lp");
leg_1D[14]->AddEntry(puppi_graph_trSigmavsNpv[2],"PFlow+PUPPI ","lp");
...
TLatex *texc15 = new TLatex(20.45501,24.0062,"Trimmed (r_{filt}=0.3,pT_{frac}=0.03)");
...
leg_1D[15]->AddEntry(pf_graph_trSigmavsNpv[3],"PFlow  ","lp");
leg_1D[15]->AddEntry(chs_graph_trSigmavsNpv[3],"PFlow+CHS ","lp");
leg_1D[15]->AddEntry(puppi_graph_trSigmavsNpv[3],"PFlow+PUPPI ","lp");
...
TLatex *texc16 = new TLatex(20.45501,24.0062,"Pruned (z_{cut}=0.1,r_{cut}=0.5)");
   texc16->SetLineWidth(0.05);
   texc16->SetTextSize(0.03);

c_1D[16]->cd();
TMg_1D[16]->Add(pf_graph_prSigmavsNpv[0]);
TMg_1D[16]->Add(chs_graph_prSigmavsNpv[0]);
TMg_1D[16]->Add(puppi_graph_prSigmavsNpv[0]);
TMg_1D[16]->SetTitle(" ;n_{PV} ;RMS[m_{RecoJet}-m_{GenJet}] (GeV) ");
TMg_1D[16]->Draw("AP");

leg_1D[16]->AddEntry(pf_graph_prSigmavsNpv[0],"PFlow  ","lp");
leg_1D[16]->AddEntry(chs_graph_prSigmavsNpv[0],"PFlow+CHS ","lp");
leg_1D[16]->AddEntry(puppi_graph_prSigmavsNpv[0],"PFlow+PUPPI ","lp");
...
////////////////////////////////////////pr2
TLatex *texc17 = new TLatex(20.45501,24.0062,"Pruned (z_{cut}=0.05,r_{cut}=0.5)");
   texc17->SetLineWidth(0.05);
   texc17->SetTextSize(0.03);

c_1D[17]->cd();
TMg_1D[17]->Add(pf_graph_prSigmavsNpv[1]);
TMg_1D[17]->Add(chs_graph_prSigmavsNpv[1]);
TMg_1D[17]->Add(puppi_graph_prSigmavsNpv[1]);
TMg_1D[17]->SetTitle(" ;n_{PV} ;RMS[m_{RecoJet}-m_{GenJet}] (GeV) ");
TMg_1D[17]->Draw("AP");

leg_1D[17]->AddEntry(pf_graph_prSigmavsNpv[1],"PFlow  ","lp");
leg_1D[17]->AddEntry(chs_graph_prSigmavsNpv[1],"PFlow+CHS ","lp");
leg_1D[17]->AddEntry(puppi_graph_prSigmavsNpv[1],"PFlow+PUPPI ","lp");
...
TLatex *texc18 = new TLatex(20.45501,24.0062,"Pruned (z_{cut}=0.05,r_{cut}=0.75)");
   texc18->SetLineWidth(0.05);
   texc18->SetTextSize(0.03);

c_1D[18]->cd();
TMg_1D[18]->Add(pf_graph_prSigmavsNpv[2]);
TMg_1D[18]->Add(chs_graph_prSigmavsNpv[2]);
TMg_1D[18]->Add(puppi_graph_prSigmavsNpv[2]);
TMg_1D[18]->SetTitle(" ;n_{PV} ;RMS[m_{RecoJet}-m_{GenJet}] (GeV) ");
TMg_1D[18]->Draw("AP");

leg_1D[18]->AddEntry(pf_graph_prSigmavsNpv[2],"PFlow  ","lp");
leg_1D[18]->AddEntry(chs_graph_prSigmavsNpv[2],"PFlow+CHS ","lp");
leg_1D[18]->AddEntry(puppi_graph_prSigmavsNpv[2],"PFlow+PUPPI ","lp");
...
leg_1D[19]->AddEntry(pf_graph_prSigmavsNpv[3],"PFlow  ","lp");
leg_1D[19]->AddEntry(chs_graph_prSigmavsNpv[3],"PFlow+CHS ","lp");
leg_1D[19]->AddEntry(puppi_graph_prSigmavsNpv[3],"PFlow+PUPPI ","lp");
...
TLatex *texc20 = new TLatex(20.45501,24.0062,"Softdrop #beta= 2");
   texc20->SetLineWidth(0.05);
   texc20->SetTextSize(0.03);

c_1D[20]->cd();
TMg_1D[20]->Add(pf_graph_sdSigmavsNpv[0]);
TMg_1D[20]->Add(chs_graph_sdSigmavsNpv[0]);
TMg_1D[20]->Add(puppi_graph_sdSigmavsNpv[0]);
TMg_1D[20]->SetTitle(" ;n_{PV} ;RMS[m_{RecoJet}-m_{GenJet}] (GeV) ");
TMg_1D[20]->Draw("AP");

leg_1D[20]->AddEntry(pf_graph_sdSigmavsNpv[0],"PFlow  ","lp");
leg_1D[20]->AddEntry(chs_graph_sdSigmavsNpv[0],"PFlow+CHS ","lp");
leg_1D[20]->AddEntry(puppi_graph_sdSigmavsNpv[0],"PFlow+PUPPI ","lp");
...
TLatex *texc21 = new TLatex(20.45501,24.0062,"Softdrop #beta= 0");
   texc21->SetLineWidth(0.05);
   texc21->SetTextSize(0.03);

c_1D[21]->cd();
TMg_1D[21]->Add(pf_graph_sdSigmavsNpv[1]);
TMg_1D[21]->Add(chs_graph_sdSigmavsNpv[1]);
TMg_1D[21]->Add(puppi_graph_sdSigmavsNpv[1]);
TMg_1D[21]->SetTitle(" ;n_{PV} ;RMS[m_{RecoJet}-m_{GenJet}] (GeV) ");
TMg_1D[21]->Draw("AP");

leg_1D[21]->AddEntry(pf_graph_sdSigmavsNpv[1],"PFlow  ","lp");
leg_1D[21]->AddEntry(chs_graph_sdSigmavsNpv[1],"PFlow+CHS ","lp");
leg_1D[21]->AddEntry(puppi_graph_sdSigmavsNpv[1],"PFlow+PUPPI ","lp");
...
TLatex *texc22 = new TLatex(20.45501,24.0062,"Softdrop #beta= 1");
   texc22->SetLineWidth(0.05);
   texc22->SetTextSize(0.03);

c_1D[22]->cd();
TMg_1D[22]->Add(pf_graph_sdSigmavsNpv[2]);
TMg_1D[22]->Add(chs_graph_sdSigmavsNpv[2]);
TMg_1D[22]->Add(puppi_graph_sdSigmavsNpv[2]);
TMg_1D[22]->SetTitle(" ;n_{PV} ;RMS[m_{RecoJet}-m_{GenJet}] (GeV) ");
TMg_1D[22]->Draw("AP");

leg_1D[22]->AddEntry(pf_graph_sdSigmavsNpv[2],"PFlow  ","lp");
leg_1D[22]->AddEntry(chs_graph_sdSigmavsNpv[2],"PFlow+CHS ","lp");
leg_1D[22]->AddEntry(puppi_graph_sdSigmavsNpv[2],"PFlow+PUPPI ","lp");
...
TMg_1D[23]->SetTitle(" ;n_{PV} ;Sigma[m_{RecoJet}-m_{GenJet}] (GeV) ");
TMg_1D[23]->Draw("AP");

leg_1D[23]->AddEntry(pf_graph_sdSigmavsNpv[3],"PFlow  ","lp");
leg_1D[23]->AddEntry(chs_graph_sdSigmavsNpv[3],"PFlow+CHS ","lp");
leg_1D[23]->AddEntry(puppi_graph_sdSigmavsNpv[3],"PFlow+PUPPI ","lp");
...
sprintf(name,"AvJetmass_Vs_nPV_15to50_%ig.pdf",j1);
cout<<"name = "<<name<<endl;
c_1D[j1]->SaveAs(name);
//c_1D[j1]->Close();

...
process.ak4PFJetsCS = ak4PFJets.clone(
...
process.ak4PFpatJetsCS = cms.EDProducer("fourVectorProducer",
                                       jetCollection = cms.untracked.InputTag("ak4PFJetsCS"),
...
#jetCollections.append("AK4PFJetsCS");
#correctionLevels.append([]);
#jetSrcName.append('ak4PFJetsCS');
...
process.p = cms.Path( process.puppiReader + validator_sequence + process.ak4PFJetsCS*process.ak4PFpatJetsCS )

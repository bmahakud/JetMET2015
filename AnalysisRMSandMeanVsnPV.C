...
sprintf(inputfile,"QCD300to470csa14.root");
...
const unsigned double markersize=2;
...
//if(i != 12424 && i !=17508 && i !=35801 && i != 41741 && i != 41949){//bad events filtered
cout<<"Event = "<<i<<endl;
     if(i==maxEvents){
     break;
                     }
...
TLatex *tex3 = new TLatex(15.79347,51.24226,"300 <p_{T} <470 GeV");
   tex3->SetLineWidth(0.02);
   tex3->SetTextSize(0.03);

TLatex *tex4 = new TLatex(17.4363,47.73537," |#eta|< 2.5");
   tex4->SetLineWidth(0.02);
   tex4->SetTextSize(0.03);
...
TLatex *texc12 = new TLatex(18.35434,44.41805,"PF ");
...
TLatex *texc13 = new TLatex(18.35434,44.41805,"PF+CHS");
...
TLatex *texc14 = new TLatex(18.35434,44.41805,"PF+PUPPI ");
...
TLatex *texc16 = new TLatex(18.35434,44.41805,"PF");
...
////////////////////////////////////////pr2
TLatex *texc17 = new TLatex(18.35434,44.41805,"PF+CHS");
...
TLatex *texc18 = new TLatex(18.35434,44.41805,"PF+PUPPI ");
...
TLatex *texc20 = new TLatex(18.35434,44.41805,"PF ");
...
TLatex *texc21 = new TLatex(18.35434,44.41805,"PF+CHS ");
...
TLatex *texc22 = new TLatex(18.35434,44.41805,"PF+PUPPI ");
...
TLatex *texc0 = new TLatex(20.45501,24.0062,"Trimmed (r_{filt}=0.2,pT_{frac}=0.05)");
...
TLatex *texc1 = new TLatex(20.45501,24.0062,"Trimmed (r_{filt}=0.1,pT_{frac}=0.03)");
...
TLatex *texc2 = new TLatex(20.45501,24.0062,"Trimmed (r_{filt}=0.2,pT_{frac}=0.03)");
...
TLatex *texc3 = new TLatex(20.45501,24.0062,"Trimmed (r_{filt}=0.3,pT_{frac}=0.03)");
...
leg_1D[12]->AddEntry(pf_graph_trSigmavsNpv[0],"Trimmed (r_{filt}=0.2,pT_{frac}=0.05)","l");
leg_1D[12]->AddEntry(pf_graph_trSigmavsNpv[1],"Trimmed (r_{filt}=0.1,pT_{frac}=0.03)","l");
leg_1D[12]->AddEntry(pf_graph_trSigmavsNpv[2],"Trimmed (r_{filt}=0.2,pT_{frac}=0.03) ","l");
leg_1D[12]->AddEntry(pf_graph_trSigmavsNpv[3],"Trimmed (r_{filt}=0.3,pT_{frac}=0.03)","l");
...
leg_1D[13]->AddEntry(chs_graph_trSigmavsNpv[0],"Trimmed (r_{filt}=0.2,pT_{frac}=0.05)","l");
leg_1D[13]->AddEntry(chs_graph_trSigmavsNpv[1],"Trimmed (r_{filt}=0.1,pT_{frac}=0.03)","l");
leg_1D[13]->AddEntry(chs_graph_trSigmavsNpv[2],"Trimmed (r_{filt}=0.2,pT_{frac}=0.03) ","l");
leg_1D[13]->AddEntry(chs_graph_trSigmavsNpv[3],"Trimmed (r_{filt}=0.3,pT_{frac}=0.03)","l");
...
leg_1D[14]->AddEntry(puppi_graph_trSigmavsNpv[0],"Trimmed (r_{filt}=0.2,pT_{frac}=0.05)","l");
leg_1D[14]->AddEntry(puppi_graph_trSigmavsNpv[1],"Trimmed (r_{filt}=0.1,pT_{frac}=0.03)","l");
leg_1D[14]->AddEntry(puppi_graph_trSigmavsNpv[2],"Trimmed (r_{filt}=0.2,pT_{frac}=0.03) ","l");
leg_1D[14]->AddEntry(puppi_graph_trSigmavsNpv[3],"Trimmed (r_{filt}=0.3,pT_{frac}=0.03)","l");
...
leg_1D[16]->AddEntry(pf_graph_prSigmavsNpv[0],"Pruned (z_{cut}=0.1,r_{cut}=0.5) ","l");
leg_1D[16]->AddEntry(pf_graph_prSigmavsNpv[1],"Pruned (z_{cut}=0.05,r_{cut}=0.5) ","l");
leg_1D[16]->AddEntry(pf_graph_prSigmavsNpv[2],"Pruned (z_{cut}=0.05,r_{cut}=0.75)","l");
leg_1D[16]->AddEntry(pf_graph_prSigmavsNpv[3],"Pruned (z_{cut}=0.1,r_{cut}=0.75)","l");
...
leg_1D[17]->AddEntry(chs_graph_prSigmavsNpv[0],"Pruned (z_{cut}=0.1,r_{cut}=0.5) ","l");
leg_1D[17]->AddEntry(chs_graph_prSigmavsNpv[1],"Pruned (z_{cut}=0.05,r_{cut}=0.5) ","l");
leg_1D[17]->AddEntry(chs_graph_prSigmavsNpv[2],"Pruned (z_{cut}=0.05,r_{cut}=0.75)","l");
leg_1D[17]->AddEntry(chs_graph_prSigmavsNpv[3],"Pruned (z_{cut}=0.1,r_{cut}=0.75)","l");
...
leg_1D[18]->AddEntry(puppi_graph_prSigmavsNpv[0],"Pruned (z_{cut}=0.1,r_{cut}=0.5) ","l");
leg_1D[18]->AddEntry(puppi_graph_prSigmavsNpv[1],"Pruned (z_{cut}=0.05,r_{cut}=0.5) ","l");
leg_1D[18]->AddEntry(puppi_graph_prSigmavsNpv[2],"Pruned (z_{cut}=0.05,r_{cut}=0.75)","l");
leg_1D[18]->AddEntry(puppi_graph_prSigmavsNpv[3],"Pruned (z_{cut}=0.1,r_{cut}=0.75)","l");
...
leg_1D[20]->AddEntry(pf_graph_sdSigmavsNpv[0],"Softdrop #beta = 2 ","l");
leg_1D[20]->AddEntry(pf_graph_sdSigmavsNpv[1],"Softdrop #beta = 0 ","l");
leg_1D[20]->AddEntry(pf_graph_sdSigmavsNpv[2],"Softdrop #beta = 1 ","l");
...
leg_1D[21]->AddEntry(chs_graph_sdSigmavsNpv[0],"Softdrop #beta = 2 ","l");
leg_1D[21]->AddEntry(chs_graph_sdSigmavsNpv[1],"Softdrop #beta = 0 ","l");
leg_1D[21]->AddEntry(chs_graph_sdSigmavsNpv[2],"Softdrop #beta = 1 ","l");
...
leg_1D[22]->AddEntry(puppi_graph_sdSigmavsNpv[0],"Softdrop #beta = 2 ","l");
leg_1D[22]->AddEntry(puppi_graph_sdSigmavsNpv[1],"Softdrop #beta = 0 ","l");
leg_1D[22]->AddEntry(puppi_graph_sdSigmavsNpv[2],"Softdrop #beta = 1 ","l");
...
sprintf(name,"RMS_Vs_nPV_15to50_%ig.pdf",j1);
cout<<"name = "<<name<<endl;
c_1D[j1]->SaveAs(name);
//c_1D[j1]->Close();
